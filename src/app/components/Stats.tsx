      ...
      <div className="grid items-center lg:grid-cols-12 gap-6 lg:gap-12">
        <div className="lg:col-span-4">
          <div className="lg:pe-6 xl:pe-12">
            <p className="text-6xl font-bold leading-10 text-green-500">
              122%
        ...
        <div className="lg:col-span-8 relative lg:before:absolute lg:before:top-0 lg:before:-start-12 lg:before:w-px lg:before:h-full lg:before:bg-gray-200 lg:before:dark:bg-gray-700">
          <div className="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-3 sm:gap-8">
            <div>
              <p className="text-3xl font-semibold text-green-500">82.95%</p>
              <p className="mt-1 text-gray-500">
                in predicting correct buy and selling point
              </p>
            </div>

            <div>
              <p className="text-3xl font-semibold text-green-500">10+</p>
              <p className="mt-1 text-gray-500">Ai Modals in EVEBOT</p>
            </div>

            <div>
              <p className="text-3xl font-semibold text-green-500">100%</p>
              <p className="mt-1 text-gray-500">User Friendly. Simple. And Intuitive.</p>
            </div>
          </div>
        </div>
      </div>
